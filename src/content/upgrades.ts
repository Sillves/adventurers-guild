...
export const UPGRADES: readonly UpgradeDef[] = [
  ...
  { id: 'war-councils',        name: 'War Councils',        description: 'Quests grant another 3% of your gold/s.',             icon: '🗺️', realmId: 'verdant', cost: { gold: 8000000 },    effect: { target: 'click-synergy', percentOfProduction: 3 } },
  { id: 'legendary-campaigns', name: 'Legendary Campaigns', description: 'Quests grant another 5% of your gold/s.',             icon: '🏅', realmId: 'verdant', cost: { gold: 1000000000 }, effect: { target: 'click-synergy', percentOfProduction: 5 } },
  // critical quests
  ...
  { id: 'heroic-strikes',      name: 'Heroic Strikes',      description: 'Crit chance doubles to 10%, crits hit for 20×.',        icon: '💥', realmId: 'verdant', cost: { gold: 40000000 },   effect: { target: 'click-crit', chance: 0.05, critMultiplier: 20 } },
